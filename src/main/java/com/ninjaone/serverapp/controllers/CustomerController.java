...
import com.ninjaone.serverapp.services.CustomerAccessService;
...
public class CustomerController {
    ...
    @GetMapping("/customerstest/{id}")
    public EntityModel<Customer> getCustomerTestById(Authentication authentication,
        @PathVariable Long id) {
        log.info("Attempting to get customer test " + id);

        Customer customer = customerAccessService.authenticateCustomerId(authentication, id);
